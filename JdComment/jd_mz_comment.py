...
# web_json_url = 'http://club.jd.com/comment/productPageComments.action?productId=%s&score=0&sortType=6&page=%d&pageSize=10'  # 京东商品评论的json页面，第一个%s参数为商品id，第二个%d参数为评论的页数
comments = set()
