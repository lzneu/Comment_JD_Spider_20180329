...
def get_comments(commentID_list, pid, ptitle, item_catagory, page_num, mongo_collection, proxiesIP,
...
def scraw_web_json(commentID_list, pid, ptitle, item_catagory, file_name, mongo_collection, proxiesIP, stnum,
    ...
    for page_num2 in range(int(stnum), max_page_num):
        ...
        contents = get_comments(commentID_list, pid, ptitle, item_catagory, page_num2, mongo_collection, proxiesIP,
                                indexCollection)
...
def main(log_collection_name, product_index, page_nummber, catalog_collection_name, target_collexction_name,
    ...
    catalog_df = read_mongo(db, catalog_collection_name, {})
    ...
    if product_index <= bottom_index:
        ...
        scraw_web_json(commentID_list, item_id, item_title, item_catagory, product_index, collection, '', startNum,
                       maxPage_num_control,
    ...
    # item_store_type =store_type_list[product_index]

    # spider_start_date =spider_start_date_list[product_index]
    # startNum = page_nummber

    # pid,ptitle,item_catagory,file_name,mongo_collection,proxiesIP,stnum
    ...
    for i in range(product_index + 1, len(catalog_df)):
        ...
        startNum = 0
        commentID_list = get_commentID_list(item_id, indexCollection)
        scraw_web_json(commentID_list, item_id, item_title, item_catagory, i, collection, proxiesIP, startNum,
                       maxPage_num_control, log_collection, indexCollection)
        # scraw_web_json(item_id, i,collection,proxiesIP,startNum)
