...
def startingOneSpider(spiderModel, db):
    ...
    try:
        jd_my_comment.main(spiderModel.log_collection_name, spiderModel.product_index, spiderModel.page_nummber, spiderModel.catalog_collection_name, spiderModel.target_collexction_name, spiderModel.maxPage_num_control, db)
