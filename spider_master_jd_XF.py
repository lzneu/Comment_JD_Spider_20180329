...
def startingOneSpider(spiderModel, db):
    ...
    try:
        jd_xf_comment.main(spiderModel.log_collection_name, spiderModel.product_index, spiderModel.page_nummber, spiderModel.catalog_collection_name, spiderModel.target_collexction_name, spiderModel.maxPage_num_control, db)
...
if __name__ == '__main__':
    ...
    for i in range(len(collection_name_list)):
        ...
        spider.python_name = 'jd_xf_comment.py'
